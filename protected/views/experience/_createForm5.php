    ...
    <div class="nine columns">
        ...
        <div class="row">
            ...
            <div class="three columns end">
                <?php echo $form->checkBox($model, 'free', array('value' => 'yes', 'id' => 'isFree')); ?>
        ...
        <div class="row">
            ...
            <div class="eight columns">
                ...
                <input type="checkbox" id='multipleAllowed1' class='multipleAllowedCheckboxes' value="1">Yes
                <input type="checkbox" id='multipleAllowed0' class='multipleAllowedCheckboxes' value="0">No
            </div>
        </div>
