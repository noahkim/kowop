                ...
                <div class="four columns">
                    ...
                    <div class="detailsNextSession">
                        ...
                        <ul>
                            ...
                            $nextSession = $user->sessions(array('with' => array('experience'),
                                                                 'condition' => '(experience.Experience_ID = ' . $model->Experience_ID . ') AND (sessions.Start > now())',
                        ...
                        <div class="enrollees">
                            <span>People enrolled in this session</span>
                            <?php
...
<div id="leaveClass" class="reveal-modal">
    ...
    <?php echo CHtml::link("Yes I'd like to leave", array('/experience/leave', 'id' => $model->Experience_ID),
                           array('class' => 'button twelve secondary radius')); ?>
    <!--    <a href="#" class="secondary button radius twelve">Yes I'd like to leave</a>-->
    <a href="#" onclick="$('#leaveClass').trigger('reveal:close'); return false;" class="secondary button radius twelve">No
                                                                                                                         way,
                                                                                                                         knowledge
                                                                                                                         is
                                                                                                                         power!</a>
